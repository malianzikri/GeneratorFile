...
public class DatabaseMYSQL {
    ...
    public ArrayList query_select_without_where(String table, String column) {
        ...
        try {
            ...
            while (rs.next()) {
                for (int i = 0; i < split_column.length; i++) {
                    hasil = hasil + "#" + split_column[i] + ":" + rs.getString(split_column[i]);
                }
                hasil = hasil.replace("null", "").trim();
                hasil = hasil.replaceFirst("#", "");
                al.add(hasil);
                hasil = "";
            }
            return al;
...
//        return hasil;
    ...
    public boolean query_update_without_where(String table, String column_update, String column_value) {
        ...
        try {
            ...
            state.executeUpdate();
            Logger.getLogger(DatabaseMYSQL.class.getName()).log(Level.SEVERE, null, "berhasil");
            connection.commit();
            return true;
//            
        } catch (SQLException ex) {
...
//        return hasil;
    ...
    public ArrayList query_select_raw(String column, String sql) {
        String hasil = "";
        ArrayList a = new ArrayList();
        String split_column[] = column.split(",");
        Statement state = null;
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        DatabaseMYSQL g = new DatabaseMYSQL();
        g.connectDatabase("localhost", "generatorcoba", "root", "");
